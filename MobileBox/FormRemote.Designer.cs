namespace MobileBox
{
    sealed partial class FormRemote
    {
        ...
        private void InitializeComponent()
        {
            ...
            自定义状态图像2.高亮 = null;
            自定义状态图像2.默认 = null;
            this.uploaButton.自定义图像 = 自定义状态图像2;
            ...
            自定义状态图像3.高亮 = null;
            自定义状态图像3.默认 = null;
            this.switchButton.自定义图像 = 自定义状态图像3;
            ...
            自定义状态图像4.高亮 = null;
            自定义状态图像4.默认 = null;
            this.copyButton.自定义图像 = 自定义状态图像4;
